...
func (p *kAccountClient) CreateAccount(ctx context.Context, Req *account.CreateAccountRequest, callOptions ...callopt.Option) (r *account.CreateAccountResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateAccount(ctx, Req)
}

func (p *kAccountClient) DeleteAccount(ctx context.Context, Req *account.DeleteAccountRequest, callOptions ...callopt.Option) (r *account.DeleteAccountResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteAccount(ctx, Req)
}

func (p *kAccountClient) UpdateAccount(ctx context.Context, Req *account.UpdateAccountRequest, callOptions ...callopt.Option) (r *account.UpdateAccountResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateAccount(ctx, Req)
}

func (p *kAccountClient) MGetAccount(ctx context.Context, Req *account.MGetAccountRequest, callOptions ...callopt.Option) (r *account.MGetAccountResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.MGetAccount(ctx, Req)
}

func (p *kAccountClient) GetAccountByUserID(ctx context.Context, Req *account.GetAccountByUserIDRequest, callOptions ...callopt.Option) (r *account.GetAccountByUserIDResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetAccountByUserID(ctx, Req)
}

func (p *kAccountClient) CreateBill(ctx context.Context, Req *account.CreateBillRequest, callOptions ...callopt.Option) (r *account.CreateBillResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateBill(ctx, Req)
}

func (p *kAccountClient) DeleteBill(ctx context.Context, Req *account.DeleteBillRequest, callOptions ...callopt.Option) (r *account.DeleteBillResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DeleteBill(ctx, Req)
}

func (p *kAccountClient) UpdateBill(ctx context.Context, Req *account.UpdateBillRequest, callOptions ...callopt.Option) (r *account.UpdateBillResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateBill(ctx, Req)
}

func (p *kAccountClient) MGetGillRequest(ctx context.Context, Req *account.MGetBillRequest, callOptions ...callopt.Option) (r *account.MGetBillResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.MGetGillRequest(ctx, Req)
}

func (p *kAccountClient) GetBillByAccountID(ctx context.Context, Req *account.GetBillByAccountIDRequest, callOptions ...callopt.Option) (r *account.GetBillByAccountIDResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
